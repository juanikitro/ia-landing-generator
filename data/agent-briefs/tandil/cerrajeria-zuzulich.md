# Site Brief 1: Cerrajeria Zuzulich
...
- id: `google-ChIJkftE_pgfkZUR1ceDCua7tUI`
- slug: `cerrajeria-zuzulich`
- name: Cerrajeria Zuzulich
- category: Locksmith
- inferred profile: Locksmith
- requested segment: rubros variados de alta conversion
- city: Tandil
- address: Belgrano 129, B7000 Tandil, Provincia de Buenos Aires, Argentina
- phone: 0249 449-8213
- hours summary: Lunes a Viernes; Sabado, Domingo cerrado
- rating: 4.8 / 5 (117 reseñas)
- service baseline: cerrajero urgencias
...
```json
{
  ...
  "final_cta": {
    "title": "Cerrajeria Zuzulich: el proximo paso es simple",
    "body": "Llama, confirma disponibilidad y lleva el auto con el dato clave ya resuelto: locksmith, direccion y horario.",
...
1. "Excelente atención , super profesional . Muy buen servicio , totalmente recomendable !!!! Regresaría sin dudarlo !" — JORGE ALBERTO SALINAS (5/5)
2. "Excelente atención como siempre. Solucionan los problemas en el momento. Muy recomendable!" — Paula Charlone (5/5)
3. "Excelente atención y servicio." — Roxana Martinez (5/5)

### Photos

1. other | allowed | https://places.googleapis.com/v1/places/ChIJkftE_pgfkZUR1ceDCua7tUI/photos/AaVGc3llJ2choVHgUHBpW8qSWgduvNznUoSCNyUDwAqwqYpthR_djwqNABS0h12yjBEeZOEk1ypIcrsv5elwO5MSfKqokH6gZJy4bllGrgiLo-Jq_CTcVnOpYLpMSa7tYO4qeIh_3n2K7PPDrofTnCKKtdrRqPKhbjDFwYFSvwZh93wEMInP_U3aamY1gJE0MGMqZ_lpMJM9DnWtOX7K5CNwZmpLm8Lr1Xo5F3Xoh3CliL_8isZkSHXQh0LsMt3nM0A5PBdCWwx_rbUxyvqWeSJJb-xJYxyZx_l7NmMdMfyXwJ28ErbObNwiJYvD6LT1p--oiJWI46JeuluXxhVyVtp2RLhEKVR-0C7snGlqWkTMXl_QZsH7C4Ssa-Elosw-lYlCzIprYkHZbyayUR8JHgMHc1n7uOFerep-h6Ar_OL9sb0/media?maxWidthPx=1600
2. other | allowed | https://places.googleapis.com/v1/places/ChIJkftE_pgfkZUR1ceDCua7tUI/photos/AaVGc3n2uaspJDpkFq_ZEdLbg8Ly31We-rvFUxrNSmjz86EB_3MA3k4U38-U5pXvTlW6g_Iy1DNFDSeGP_zUBAqPv-_PBrdXAOH8m5fnoKcgBT5jzC3JkHxlvcvphFZ-AIGJfUm7mmL7F6WXOvt6Vgvx03vYnG_cnTQEbRPkSY9IyMAqYLIK8s_mqyEH2eRC2N--CoyLjrK8Om-Qck4v40lo2xkyUUxDq0-uIDJAv-bEAuU-13f5WbjZwXbqhlb-p6BmxPW32m_ToumDgOeXzz-MGIQq1CC-EFd27TK78prb3WUzHk57Ivfq0S4yprd_xiy2oflgx5WrwnrSqfEJ4VGWZHfd5EwMZbPQA15sIGyii7aALm6LI2UoF4H3Nu09shNrW58TtO4HfWduauq62GmWSj_S6Tx5jTwdoXLGH6ufGmlP3pcj/media?maxWidthPx=1600
3. other | allowed | https://places.googleapis.com/v1/places/ChIJkftE_pgfkZUR1ceDCua7tUI/photos/AaVGc3lf2ApAudpB1-eCVf2sva6-EHwo6CNlHYdgEAz9e2nHvBULiBQ360NgMYuznXlB_ARn6u_BpfjdKE9BBXY_CA2toMG3aVpf9rRulP2vs3LisgixSA-co33uOZwU-DeXN_mqFr2JCicKOlVMIJlSET8g-i7eESCTE0V3wWdnH1tvBcgO-zD91Mg0zRIAko3T0aBbvZnqALzMlAgRIldIW5jbryIW4hqrKY5NB06dGohrobnCoq7Hb3JViaLxLliqzxjDz0aRVFAL671FGUrjDXM_1c-GgRn1mx_L1Y0tO17-LA0vYMlQAHfWge18o2Mm-iWICU0kOubsGcG8FgnSG6_JsjTrlnKAj3jOl_S1HXFhmcaXH7Sbg40pTEt1nEZh_mRtMkMx_e_fyFp4z0pYuCzyC0mWXmWaJGxv8B66v55W7cnx/media?maxWidthPx=1600

### Sources

- https://maps.google.com/?cid=4806954773981153237&g_mp=CiVnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLkdldFBsYWNlEAIYBCAA
- https://www.google.com/maps/contrib/113023742438733511052/reviews
- https://www.google.com/maps/contrib/105030690502700355660/reviews
- https://www.google.com/maps/contrib/116020148198044582052/reviews
...
- `agent_frontend`: required for final quality generation:
  ...
  - `source_dir`: source folder kept inside this repo, for example `data/frontends/tandil-rubros-variados-de-alta-conversion/cerrajeria-zuzulich`
